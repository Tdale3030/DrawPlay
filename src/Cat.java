...
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		//moving meow to the right so it looks like its coming out of cats mouth
		g2.drawString("Meow", catX+80, catY+HEAD_DIMENSION+10);	
	}
}
